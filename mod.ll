...
@.str.4 = private unnamed_addr constant [13 x i8] c"TO_string[]_\00", align 1
@.str.5 = private unnamed_addr constant [8 x i8] c"\1B[2J\1B[H\00", align 1
@.str.6 = private unnamed_addr constant [10 x i8] c"%c[%d;%df\00", align 1
@.str.7 = private unnamed_addr constant [8 x i8] c"\1B[?251]\00", align 1
...
declare noalias i8* @GC_malloc(i64 noundef) #3
