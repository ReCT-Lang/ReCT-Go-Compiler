...
%struct.String_vTable = type { %struct.any_vtable*, i8* }
%struct.Int_vTable = type { %struct.any_vtable*, i8* }
%struct.Float_vTable = type { %struct.any_vtable*, i8* }
%struct.Bool_vTable = type { %struct.any_vtable*, i8* }
%struct.class_Any = type { %struct.any_vtable* }
%struct.class_String = type { %struct.String_vTable*, i8*, i32, i32, i32 }
%struct.class_Int = type { %struct.Int_vTable*, i32 }
%struct.class_Float = type { %struct.Float_vTable*, float }
%struct.class_Bool = type { %struct.Bool_vTable*, i8 }

@.str = private unnamed_addr constant [4 x i8] c"Any\00", align 1
@Any_vTable_Const = dso_local constant %struct.any_vtable { %struct.any_vtable* null, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0) }, align 8
@.str.1 = private unnamed_addr constant [7 x i8] c"String\00", align 1
@String_vTable_Const = dso_local constant %struct.String_vTable { %struct.any_vtable* @Any_vTable_Const, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0) }, align 8
@.str.2 = private unnamed_addr constant [4 x i8] c"Int\00", align 1
@Int_vTable_Const = dso_local constant %struct.Int_vTable { %struct.any_vtable* @Any_vTable_Const, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0) }, align 8
@.str.3 = private unnamed_addr constant [6 x i8] c"Float\00", align 1
@Float_vTable_Const = dso_local constant %struct.Float_vTable { %struct.any_vtable* @Any_vTable_Const, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0) }, align 8
@.str.4 = private unnamed_addr constant [5 x i8] c"Bool\00", align 1
@Bool_vTable_Const = dso_local constant %struct.Bool_vTable { %struct.any_vtable* @Any_vTable_Const, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0) }, align 8

; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @Any_public_Contructor(%struct.class_Any* %0) #0 {
...
; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @String_public_Contructor(%struct.class_String* %0) #0 {
...
; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @String_public_Die(%struct.class_String* %0) #0 {
  %2 = alloca %struct.class_String*, align 8
  store %struct.class_String* %0, %struct.class_String** %2, align 8
  %3 = load %struct.class_String*, %struct.class_String** %2, align 8
...
7:                                                ; preds = %1
  %8 = load %struct.class_String*, %struct.class_String** %2, align 8
  %9 = getelementptr inbounds %struct.class_String, %struct.class_String* %8, i32 0, i32 1
...
; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @Int_public_Contructor(%struct.class_Int* %0, i32 %1) #0 {
...
; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @Int_public_Die(%struct.class_Int* %0) #0 {
...
define dso_local i32 @Int_public_GetValue(%struct.class_Int* %0) #0 {
  ...
  %4 = getelementptr inbounds %struct.class_Int, %struct.class_Int* %3, i32 0, i32 1
  %5 = load i32, i32* %4, align 8
  ret i32 %5
}

; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @Float_public_Contructor(%struct.class_Float* %0, float %1) #0 {
  ...
  store float %7, float* %9, align 8
  ret void
}

; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @Float_public_Die(%struct.class_Float* %0) #0 {
...
define dso_local float @Float_public_GetValue(%struct.class_Float* %0) #0 {
  ...
  %4 = getelementptr inbounds %struct.class_Float, %struct.class_Float* %3, i32 0, i32 1
  %5 = load float, float* %4, align 8
  ret float %5
}

; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @Bool_public_Contructor(%struct.class_Bool* %0, i1 zeroext %1) #0 {
  ...
  %9 = trunc i8 %8 to i1
  %10 = load %struct.class_Bool*, %struct.class_Bool** %3, align 8
  %11 = getelementptr inbounds %struct.class_Bool, %struct.class_Bool* %10, i32 0, i32 1
  %12 = zext i1 %9 to i8
...
; Function Attrs: noinline nounwind optnone sspstrong uwtable
define dso_local void @Bool_public_Die(%struct.class_Bool* %0) #0 {
...
define dso_local zeroext i1 @Bool_public_GetValue(%struct.class_Bool* %0) #0 {
  ...
  %4 = getelementptr inbounds %struct.class_Bool, %struct.class_Bool* %3, i32 0, i32 1
  %5 = load i8, i8* %4, align 8
  %6 = trunc i8 %5 to i1
  ret i1 %6
}
